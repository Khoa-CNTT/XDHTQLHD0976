            ...
            <div class="bg-blue-50 p-4 rounded-lg mb-6 border border-blue-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input type="text" name="identity_card" id="identity_card" class="w-full border border-gray-300 rounded px-4 py-2 @error('identity_card') border-red-500 @enderror" value="{{ old('identity_card', $employee->user->identity_card) }}" required maxlength="12">
                        @error('identity_card')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="dob" id="dob" class="w-full border border-gray-300 rounded px-4 py-2 @error('dob') border-red-500 @enderror" value="{{ old('dob', $employee->user->dob) }}" required>
                        @error('dob')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="bg-green-50 p-4 rounded-lg mb-6 border border-green-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input type="text" name="salary_display" id="salary_display" class="w-full border border-gray-300 rounded px-4 py-2 @error('salary') border-red-500 @enderror" value="{{ old('salary_display', number_format($employee->salary, 0, ',', '.')) }}" required oninput="formatSalary(this)">
                        <input type="hidden" name="salary" id="salary" value="{{ old('salary', $employee->salary) }}">
                        @error('salary')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
